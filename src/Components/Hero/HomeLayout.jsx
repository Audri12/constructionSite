...
<div>
<button className='bg-[#FF7906] text-lg font-roboto text-white px-16	py-4 my-6 border-2 border-[#FF7906] hover:bg-[#0C2239] rounded-md mr-5'>Recent Works</button>
<button className='text-lg font-roboto text-white px-16 bg-gray-500 border-2 border-white py-4 my-6 hover:bg-[#DC6600] rounded-md'>Managing Director</button>
</div>
     </div>
  </div>
