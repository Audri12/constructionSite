    ...
    <header>
      <nav className="bg-[#F5F5F5] h-[99px]">
        <div className="relative h-full container mx-auto flex flex-wrap justify-between items-center px-[5%] ">
          ...
          {showDiv && (
            <div
              className={`border-blue-500 border-[1px] bg-[#F4F4F4] absolute top-full right-4 py-3 w-full md:w-[20%] flex justify-center items-center transition-all ease-in-out duration-300 ${
